...
import { 
  ...
  ChevronDown, Plus, Trash2, ChevronLeft, ChevronRight
} from 'lucide-react';
      ...
      <div className="flex items-center space-x-6">
        ...
        <div className="flex flex-col items-center space-y-2 border-r border-gray-200 pr-6">
          <div className="flex items-center space-x-2">
            <button className="flex flex-col items-center p-2 hover:bg-gray-100 rounded-md" onClick={() => setShowSpelling(true)}>
              <CheckCircle className="w-6 h-6 text-gray-700" />
              <span className="text-xs">Spelling & Grammar</span>
            </button>
            <button className="flex flex-col items-center p-2 hover:bg-gray-100 rounded-md" onClick={() => setShowThesaurus(true)}>
              <BookOpen className="w-6 h-6 text-gray-700" />
              <span className="text-xs">Thesaurus</span>
            </button>
            <button className="flex flex-col items-center p-2 hover:bg-gray-100 rounded-md" onClick={() => setShowWordCount(true)}>
        ...
        <div className="flex flex-col items-center space-y-2 border-r border-gray-200 pr-6">
          <div className="flex items-center space-x-2">
            <button className="flex flex-col items-center p-2 hover:bg-gray-100 rounded-md" onClick={() => setShowReadAloud(true)}>
        ...
        <div className="flex flex-col items-center space-y-2 border-r border-gray-200 pr-6">
          <div className="flex items-center space-x-2">
            <button className="flex flex-col items-center p-2 hover:bg-gray-100 rounded-md" onClick={() => setShowAccessibility(true)}>
        ...
        <div className="flex flex-col items-center space-y-2 border-r border-gray-200 pr-6">
          <div className="flex items-center space-x-2">
            <button className="flex flex-col items-center p-2 hover:bg-gray-100 rounded-md" onClick={() => setShowTranslate(true)}>
              <Languages className="w-6 h-6 text-gray-700" />
              <span className="text-xs">Translate</span>
            </button>
            <div className="relative group">
              <button className="flex flex-col items-center p-2 hover:bg-gray-100 rounded-md" onClick={() => setShowLanguage(true)}>
                <div className="w-6 h-6 flex items-center justify-center text-gray-700">
                  <span className="text-sm">🌐</span>
                </div>
        ...
        <div className="flex flex-col items-center space-y-2 border-r border-gray-200 pr-6">
          <div className="flex items-center space-x-2">
            ...
            <button className="flex flex-col items-center p-2 hover:bg-gray-100 rounded-md" onClick={() => setShowComments(true)}>
        ...
        <div className="flex flex-col items-center space-y-2 border-r border-gray-200 pr-6">
          <div className="flex items-center space-x-2">
            ...
            <button className="flex flex-col items-center p-2 hover:bg-gray-100 rounded-md" onClick={() => setShowTrackChanges(true)}>
              <Eye className="w-6 h-6 text-gray-700" />
              <span className="text-xs">Display for Review</span>
            </button>
            <button className="flex flex-col items-center p-2 hover:bg-gray-100 rounded-md" onClick={() => setShowReviewingPane(true)}>
              <div className="w-6 h-6 flex items-center justify-center text-gray-700">
                <span className="text-sm">📊</span>
              </div>
        ...
        <div className="flex flex-col items-center space-y-2 border-r border-gray-200 pr-6">
          <div className="flex items-center space-x-2">
            <div className="relative group">
              <button className="flex flex-col items-center p-2 hover:bg-gray-100 rounded-md" onClick={() => setShowAccept(true)}>
            ...
            <div className="relative group">
              <button className="flex flex-col items-center p-2 hover:bg-gray-100 rounded-md" onClick={() => setShowReject(true)}>
                <div className="flex items-center space-x-1">
        ...
        <div className="flex flex-col items-center space-y-2 border-r border-gray-200 pr-6">
          <div className="flex items-center space-x-2">
            <button className="flex flex-col items-center p-2 hover:bg-gray-100 rounded-md" onClick={() => setShowCompare(true)}>
              <div className="w-6 h-6 flex items-center justify-center text-gray-700">
                <span className="text-sm">🔍</span>
              </div>
              <span className="text-xs">Compare</span>
            </button>
            <button className="flex flex-col items-center p-2 hover:bg-gray-100 rounded-md" onClick={() => setShowCombine(true)}>
              <div className="w-6 h-6 flex items-center justify-center text-gray-700">
                <span className="text-sm">🔗</span>
              </div>
