      ...
      <div className="flex items-center space-x-6 flex-wrap">
        ...
        <div className="flex flex-col items-center space-y-2 border-r border-gray-200 pr-6">
          <div className="flex items-center space-x-2">
            <button className="flex flex-col items-center p-2 hover:bg-gray-100 rounded-md" onClick={() => setShowWatermark(true)}>
            ...
            <button className="flex flex-col items-center p-2 hover:bg-gray-100 rounded-md" onClick={() => setShowPageBorders(true)}>
        ...
        <div className="flex flex-col space-y-2">
          ...
          <div className="flex items-center space-x-2">
            <button className="flex flex-col items-center p-2 hover:bg-gray-100 rounded-md" onClick={() => setShowColors(true)}>
              <Palette className="w-6 h-6 text-gray-700" />
              <span className="text-xs">Colors</span>
            </button>
            <button className="flex flex-col items-center p-2 hover:bg-gray-100 rounded-md" onClick={() => setShowFonts(true)}>
              <Type className="w-6 h-6 text-gray-700" />
              <span className="text-xs">Fonts</span>
            </button>
            <button className="flex flex-col items-center p-2 hover:bg-gray-100 rounded-md" onClick={() => setShowEffects(true)}>
              <div className="w-6 h-6 flex items-center justify-center text-gray-700">
                <span className="text-sm">✨</span>
              </div>
              <span className="text-xs">Effects</span>
            </button>
            <button className="flex flex-col items-center p-2 hover:bg-gray-100 rounded-md" onClick={() => setShowSetDefault(true)}>
