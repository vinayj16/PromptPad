      ...
      <div className="flex items-center space-x-6 flex-wrap">
        ...
        <div className="flex flex-col items-center space-y-2 border-r border-gray-200 pr-6">
          <div className="flex items-center space-x-2">
            ...
            <button className="flex flex-col items-center p-2 hover:bg-gray-100 rounded-md" onClick={() => setShowAddText(true)}>
              <Plus className="w-6 h-6 text-gray-700" />
              <span className="text-xs">Add Text</span>
            </button>
            <button className="flex flex-col items-center p-2 hover:bg-gray-100 rounded-md" onClick={() => setShowUpdateTable(true)}>
        ...
        <div className="flex flex-col items-center space-y-2 border-r border-gray-200 pr-6">
          <div className="flex items-center space-x-2">
            <button className="flex flex-col items-center p-2 hover:bg-gray-100 rounded-md" onClick={() => setShowFootnote(true)}>
              <div className="w-6 h-6 flex items-center justify-center text-gray-700">
                <span className="text-sm font-bold">¹</span>
              </div>
              <span className="text-xs">Insert Footnote</span>
            </button>
            <button className="flex flex-col items-center p-2 hover:bg-gray-100 rounded-md" onClick={() => setShowEndnote(true)}>
              <div className="w-6 h-6 flex items-center justify-center text-gray-700">
                <span className="text-sm font-bold">ⁱ</span>
              </div>
              <span className="text-xs">Insert Endnote</span>
            </button>
            <button className="flex flex-col items-center p-2 hover:bg-gray-100 rounded-md" onClick={() => setShowNextFootnote(true)}>
              <Search className="w-6 h-6 text-gray-700" />
              <span className="text-xs">Next Footnote</span>
            </button>
            <button className="flex flex-col items-center p-2 hover:bg-gray-100 rounded-md" onClick={() => setShowShowNotes(true)}>
              <div className="w-6 h-6 flex items-center justify-center text-gray-700">
                <span className="text-sm">📋</span>
              </div>
        ...
        <div className="flex flex-col items-center space-y-2 border-r border-gray-200 pr-6">
          <div className="flex items-center space-x-2">
            ...
            <button className="flex flex-col items-center p-2 hover:bg-gray-100 rounded-md" onClick={() => setShowInsertCitation(true)}>
              <Quote className="w-6 h-6 text-gray-700" />
              <span className="text-xs">Insert Citation</span>
            </button>
            <button className="flex flex-col items-center p-2 hover:bg-gray-100 rounded-md" onClick={() => setShowManageSources(true)}>
              <BookOpen className="w-6 h-6 text-gray-700" />
              <span className="text-xs">Manage Sources</span>
            </button>
            <button className="flex flex-col items-center p-2 hover:bg-gray-100 rounded-md" onClick={() => setShowBibliography(true)}>
        ...
        <div className="flex flex-col items-center space-y-2 border-r border-gray-200 pr-6">
          <div className="flex items-center space-x-2">
            <button className="flex flex-col items-center p-2 hover:bg-gray-100 rounded-md" onClick={() => setShowInsertCaption(true)}>
              <div className="w-6 h-6 flex items-center justify-center text-gray-700">
                <span className="text-sm">📷</span>
              </div>
              <span className="text-xs">Insert Caption</span>
            </button>
            <button className="flex flex-col items-center p-2 hover:bg-gray-100 rounded-md" onClick={() => setShowInsertTableOfFigures(true)}>
              <List className="w-6 h-6 text-gray-700" />
              <span className="text-xs">Insert Table of Figures</span>
            </button>
            <button className="flex flex-col items-center p-2 hover:bg-gray-100 rounded-md" onClick={() => setShowUpdateTableFigures(true)}>
              <div className="w-6 h-6 flex items-center justify-center text-gray-700">
                <span className="text-sm">🔄</span>
              </div>
              <span className="text-xs">Update Table</span>
            </button>
            <button className="flex flex-col items-center p-2 hover:bg-gray-100 rounded-md" onClick={() => setShowCrossReference(true)}>
        ...
        <div className="flex flex-col items-center space-y-2 border-r border-gray-200 pr-6">
          <div className="flex items-center space-x-2">
            <button className="flex flex-col items-center p-2 hover:bg-gray-100 rounded-md" onClick={() => setShowMarkEntry(true)}>
              <Hash className="w-6 h-6 text-gray-700" />
              <span className="text-xs">Mark Entry</span>
            </button>
            <button className="flex flex-col items-center p-2 hover:bg-gray-100 rounded-md" onClick={() => setShowInsertIndex(true)}>
              <FileText className="w-6 h-6 text-gray-700" />
              <span className="text-xs">Insert Index</span>
            </button>
            <button className="flex flex-col items-center p-2 hover:bg-gray-100 rounded-md" onClick={() => setShowUpdateIndex(true)}>
              <div className="w-6 h-6 flex items-center justify-center text-gray-700">
                <span className="text-sm">🔄</span>
              </div>
        ...
        <div className="flex flex-col items-center space-y-2">
          <div className="flex items-center space-x-2">
            <button className="flex flex-col items-center p-2 hover:bg-gray-100 rounded-md" onClick={() => setShowMarkCitation(true)}>
              <div className="w-6 h-6 flex items-center justify-center text-gray-700">
                <span className="text-sm">⚖️</span>
              </div>
              <span className="text-xs">Mark Citation</span>
            </button>
            <button className="flex flex-col items-center p-2 hover:bg-gray-100 rounded-md" onClick={() => setShowInsertTableAuthorities(true)}>
              <FileText className="w-6 h-6 text-gray-700" />
              <span className="text-xs">Insert Table of Authorities</span>
            </button>
            <button className="flex flex-col items-center p-2 hover:bg-gray-100 rounded-md" onClick={() => setShowUpdateTableAuthorities(true)}>
              <div className="w-6 h-6 flex items-center justify-center text-gray-700">
                <span className="text-sm">🔄</span>
              </div>
              <span className="text-xs">Update Table</span>
